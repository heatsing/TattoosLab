        ...
        {isAuth0Configured ? (
          <div className="max-w-sm w-full rounded-xl border border-white/10 bg-white/5 p-8 text-center">
            ...
            <Button asChild className="w-full">
              <a href="/auth/login?screen_hint=signup&returnTo=/dashboard">Create Account</a>
            </Button>
          ...
          <div className="max-w-sm w-full rounded-xl border border-white/10 bg-white/5 p-8 text-center">
            ...
            <h2 className="text-lg font-semibold text-white mb-2">Get Started</h2>
            <p className="text-sm text-white/60 mb-6">
              Authentication is not configured. Add your Auth0 environment variables to enable sign up.
            </p>
            <Link href="/dashboard">
